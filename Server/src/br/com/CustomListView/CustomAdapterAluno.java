...
public class CustomAdapterAluno extends BaseAdapter {

	Context context;
	List<RowItemAluno> rowItems;

	public CustomAdapterAluno(Context context, List<RowItemAluno> rowItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.list_item_aluno, null);
			holder = new ViewHolder();

			holder.imagemPerfil = (ImageView) convertView
					.findViewById(R.id.imgFotoPerfilAluno);
			holder.nomePerfil = (TextView) convertView
					.findViewById(R.id.txtNomePerfilAluno);
			holder.usuarioAlunoPerfil = (TextView) convertView
					.findViewById(R.id.txtUsuarioPerfilAluno);
			

			RowItemAluno row_pos = rowItems.get(position);
