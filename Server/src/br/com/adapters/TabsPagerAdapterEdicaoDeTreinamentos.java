...
public class TabsPagerAdapterEdicaoDeTreinamentos extends FragmentPagerAdapter {

	public TabsPagerAdapterEdicaoDeTreinamentos(FragmentManager fm) {
		super(fm);
	}
	...
	public Fragment getItem(int index) {
		...
		switch (index) {
		case 0:
		    return new EditarTreinamentoExerciciosAerobicos();
	
		case 1:
			return new EditarTreinamentoExerciciosAnaerobicos();
