...
import br.com.GUI.perfil.MeuPersonal;
import br.com.GUI.perfil.MeusAlunos;
import br.com.GUI.perfil.PerfilAluno;
import br.com.GUI.perfil.PerfilPersonal;
import br.com.GUI.treinamentos.AcompanhamentoTreinamento;
...
public class TabsPagerAdapterHomeAluno extends FragmentPagerAdapter {

	public TabsPagerAdapterHomeAluno(FragmentManager fm) {
		super(fm);
	}
