				...
				public void onItemSelected(AdapterView<?> arg0, View arg1,
					...
					if(spnMetodoDeCalculo.getItemAtPosition(arg2).toString().equals("Jackson 4")){
						...
						if(avaliado.getSexo().equals("Masculino")){
							...
							Toast.makeText(getActivity(),  "Desculpe este método é indicado apenas para homens", Toast.LENGTH_LONG).show();
						}
						...
						Toast.makeText(getActivity(), CalcularGorduraCorporal.getIndicacaoJackson4Atletas(), Toast.LENGTH_LONG).show();
						if(avaliado.getSexo().equals("Masculino")){
							Toast.makeText(getActivity(),  "Desculpe este método é indicado apenas para Mulheres", Toast.LENGTH_LONG).show();
						}else if(avaliado.getSexo().equals("Feminino")){
							tomadaDobraAbdominal.setVisibility(View.VISIBLE);
							tomadaDobraCoxa.setVisibility(View.VISIBLE);
							tomadaDobraSubscapular.setVisibility(View.GONE);
