...
public class ConfirmarAula extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String dataAula = getString(R.string.label_data_da_aula) +  aula.getMesAula()+ "/" + aula.getDiaAula() + "/" + aula.getAnoAula();
		String horaAula = getString(R.string.label_hora_da_aula) + aula.getHoraAula() + ":" + aula.getMinutoAula();
		String duracaoAula = getString(R.string.label_duracao) + aula.getDuracaoAula() + getString(R.string.label_minutos);
		...
		if (pref.getString("tipo", null).equals("personal")){
				...
				if (flag){
					if(aula.confirmarCancelarAulaPersonal(b, confirmaAula)){
						Toast.makeText(ConfirmarAula.this, R.string.mensagens_aula_confirmada, Toast.LENGTH_SHORT).show();
						finish();
					}
				}else{
					Toast.makeText(ConfirmarAula.this, R.string.mensagens_erro_ao_cancelar, Toast.LENGTH_SHORT).show();
				}
				...
				if (flag){
					if(aula.confirmarCancelarAulaAluno(b, confirmaAula)){
						Toast.makeText(ConfirmarAula.this, getString(R.string.mensagens_aula_confirmada), Toast.LENGTH_SHORT).show();
						finish();
					}
				}else{
					Toast.makeText(ConfirmarAula.this, getString(R.string.mensagens_erro_ao_cancelar), Toast.LENGTH_SHORT).show();
