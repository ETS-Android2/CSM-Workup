...
public class RowItemPersonal {
		...
		public RowItemPersonal(Bitmap imagemPerfil, String nomePerfil,
				String usuarioPersonal, String telefonePersonal) {
			super();
